 ...
 */
public class PedidoServiceLiberar extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PedidoServiceLiberar() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String aprovacao[] = stringToList(request.getParameter("aprovacao"));
		
		DTOPedido pedido = new DTOPedido();
		
		PrintWriter out = response.getWriter();
		out.print(pedido.liberar(aprovacao));
		out.close();
